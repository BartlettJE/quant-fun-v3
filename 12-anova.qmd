...
In this example, we will be using data from experiment 2 of ['Computer game play reduces intrusive memories of experimental trauma via reconsolidation-update mechanisms'](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4526368/){target="_blank"} [@james_computer_2015].
