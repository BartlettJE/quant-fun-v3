...
|:--------------:|:---------------------------------|:-------------------------------|
| Gender | `r typeof(zhang_data$Gender)`|              |
| Age  | `r typeof(zhang_data$Age)`|  |
| Condition | `r typeof(zhang_data$Condition)`|  |
| time1_interest | `r typeof(zhang_data$time1_interest)`|  |
| time2_interest | `r typeof(zhang_data$time2_interest)`|  |
| participant_ID | `r typeof(zhang_data$participant_ID)`|  |
...
ggplot(zhang_data, aes(x = time1_interest,y = Age))+
       geom_point()
```
