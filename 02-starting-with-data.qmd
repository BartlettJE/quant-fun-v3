...
In this chapter, we introduce you to using code to create **`r glossary("reproducible research")`**. We will cover things such as file structure and setting a working directory, using **`r glossary("R markdown", display = "R Markdown")`** files, and writing code chunks. 
...
#| fig.cap: "Prescribed files structure for Research Methods 1 and 2."
...
As our final step we are going to **`r glossary("knit")`** our file. This means that we're going to compile (i.e. turn) our code into a document that is more presentable. 
