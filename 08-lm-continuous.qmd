...
To isolate each plot, we can use the `which` argument. Plot 1 helps us check linearity by showing the residuals on the y-axis and the fitted values on the x-axis. 
...
Plot 2 helps us check linearity by showing the residuals on the y-axis and the fitted values on the x-axis. 
...
Plot 1 helps us check linearity by showing the residuals on the y-axis and the fitted values on the x-axis. 
...
Instead of $b_1$ for the unstandardised coefficient, we use Beta instead $\beta_1$ for the standardised coefficient).
