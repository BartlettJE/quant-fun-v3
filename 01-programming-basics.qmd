...
- How to navigate and interact with RStudio. 

- How to use an R function and find help documentation. 

- How to install and load R packages. 

- Learn how to assign content to an object.

- Learn where to find support from online resources and from the course team. 
...
### Activity 3 - Install the tidyverse to your own computer
...
You will constantly be creating objects throughout this course and you will learn more about them and how they behave as we go along. For now, it is enough to understand that they are a way of saving values, that these values can be numbers, text, or the result of operations, and that you can use objects in further operations to create new objects or variables.

::: {.callout-note}
You may also see people refer to objects as 'variables'. There is a difference between the two in programming terms but they are often used synonymously.
:::
